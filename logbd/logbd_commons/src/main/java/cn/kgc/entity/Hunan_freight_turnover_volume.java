...
public class Hunan_freight_turnover_volume {
	...
	public Hunan_freight_turnover_volume(Integer years, double total_railway,
			double national_railway, double local_railway,
			double joint_venture_railway, double highway, double waterway) {
		super();
		this.years = years;
	...
	public Hunan_freight_turnover_volume() {
		super();
	}
	...
	public String toString() {
		return "Hunan_freight_turnover_volume [years=" + years

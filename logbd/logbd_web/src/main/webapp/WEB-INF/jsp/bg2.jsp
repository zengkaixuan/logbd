...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/bg2.js"></script>
<style type="text/css">
...
<div>
	<div class="left">
		...
		<div class="lines">
			<div onclick="pageClick(this)" class="div1" >
				<img src="${pageContext.request.contextPath}/img/icon-3.png" />用户信息
			</div>
			<div onclick="pageClick(this)"  class="div2">
				<img src="${pageContext.request.contextPath}/img/icon-5.png" />湖南省业务量
			</div>
			...
			<div onclick="pageClick(this)"  class="div5">
				<img src="${pageContext.request.contextPath}/img/icon-5.png" />湖南省货运周转量
			</div>
			...
			<div onclick="pageClick(this)"  class="div7">
				<img src="${pageContext.request.contextPath}/img/icon-5.png" />湖南省交通就业量
			</div>
			...
			<div onclick="pageClick(this)"  class="div9">
				<img src="${pageContext.request.contextPath}/img/icon-5.png" />湖南公路营运汽车
			</div>
		</div>
	</div>
	<div class="top">
		<div class="leftTiyle" id="flTitle">欢迎</div>
		<div class="back"><a href="${pageContext.request.contextPath}/index">返回前台</a></div>

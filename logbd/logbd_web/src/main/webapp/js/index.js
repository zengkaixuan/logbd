$(function () {
    ...
    function echart_1() {
        ...
        option = {
            ...
            legend: {
                x: 'center',
                y: '15%',
                data: [ '长沙', '株洲', '湘潭','邵阳', '岳阳', '常德','张家界','永州', '怀化'],
                icon: 'circle',
                textStyle: {
                    color: '#fff',
                }
    ...
    $('.t_btn2').click(function(){
        window.location.href = "./page/index.jsp?id=2";
    });
    $('.t_btn3').click(function(){
        window.location.href = "./page/index.jsp?id=3";
    });
    $('.t_btn4').click(function(){
        window.location.href = "./page/index.jsp?id=4";
    });
    $('.t_btn5').click(function(){
        window.location.href = "./page/index.jsp?id=5";
    });
    $('.t_btn6').click(function(){
        window.location.href = "./page/index.jsp?id=6";
    });
    $('.t_btn7').click(function(){
        window.location.href = "./page/index.jsp?id=7";
    });
    $('.t_btn8').click(function(){
        window.location.href = "./page/index.jsp?id=8";
    });
    $('.t_btn9').click(function(){
        window.location.href = "./page/index.jsp?id=9";
    });
});
